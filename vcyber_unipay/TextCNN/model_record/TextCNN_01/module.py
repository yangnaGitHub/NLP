...
class TextCNN(object):
    ...
    def construct(self):
        ...
        with tf.device('/cpu:0'), tf.name_scope('embedding'):#词向量#tf.device('/cpu:0')
            ...
            if self.args.local_debug:
                print('embedding', self.embedded_chars.shape, self.embedded_chars_expanded.shape)#natasha here
        ...
        for index in range(conv_maxpool_count):
            ...
            with tf.name_scope(layername):
                ...
                if self.args.local_debug:
                    print('(%s)pooled::' % (layername), pooled.shape)
        ...
        if self.args.local_debug:
            print('combine:', self.h_pool, self.h_pool_flat.shape)
        ...
        with tf.name_scope("dropout"):
            if 1 == use_attention:
                ...
                if self.args.local_debug:
                    print('use_attention params error\n')
